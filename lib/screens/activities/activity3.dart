                    ...
                    child: WaveSlider(
                      ...
                      onChanged: (double dragUpdate) {
                        setState(() {
                          ...
                          String dataValues =
                              "activity3::Slider1: ${_dragPercentage1.toStringAsFixed(2)}";
                          print(dataValues);
                      ...
                      onChanged: (double dragUpdate) {
                        setState(() {
                          _dragPercentage2 = dragUpdate *
                              100; // dragUpdate is a fractional value between 0 and 1
                          String dataValues =
                              "activity3::Slider2: ${_dragPercentage2.toStringAsFixed(2)}";
                          print(dataValues);
                          writeData(dataValues);
                        });
                      },
                  ...
                  Padding(
                    ...
                    child: LiteRollingSwitch(
                      ...
                      onChanged: (bool state) {
                        ...
                        String dataValues = "activity3::Switch1: $switch1";
                        print(dataValues);
                        writeData(dataValues);
                      },
                    ),
                  ...
                  Padding(
                    ...
                    child: LiteRollingSwitch(
                      ...
                      onChanged: (bool state) {
                        ...
                        String dataValues = "activity3::Switch2: $switch2";
                        print(dataValues);
                        writeData(dataValues);
                      },
                    ),
